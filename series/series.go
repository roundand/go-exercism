...
// All returns an array of substrings of specified length from a string
...
// UnsafeFirst returns firsts substring of specified length from a string
func UnsafeFirst(n int, s string) string {
	return s[:n] // fingers in ears, eyes closed, "la la la la la ..."
}

// First returns first substring of specified length from a string, plus an error indicator
